...
class ImenikTest {
    ...
    void testDajBroj() {
        ...
        imenik.dodaj("Jozo Jozic", new MobilniBroj(64, "987-654"));
        imenik.dodaj("John Smith", new MedunarodniBroj("+1", "23 45-67-89"));
        assertEquals( "064/987-654", imenik.dajBroj("Jozo Jozic"));
    }
    ...
    //Test polimofirni set
    @Test

    void razliciti(){
        Imenik imenik=new Imenik();
        imenik.dodaj("David Gilmour", new MobilniBroj(63,"673-938"));
        imenik.dodaj("Dawson Meyers", new MedunarodniBroj("+3","982-323"));
        imenik.dodaj("Demi Moore", new FiksniBroj(ORASJE,"673-938"));
        String s=imenik.naSlovo('D');
        assertEquals("1. Dawson Meyers - +3/982-323\n2. Demi Moore - 031/673-938\n3. David Gilmour - 063/673-938\n",s);
